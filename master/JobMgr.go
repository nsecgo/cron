...
func (jobMgr *JobMgr) SaveJob(job *common.Job) (oldJob *common.Job, err error) {
	...
	// 保存到etcd
	if putResp, err = jobMgr.client.Put(context.TODO(), jobKey, string(jobValue), clientv3.WithPrevKV()); err != nil {
		return
	}
	// 如果是更新, 那么返回旧值
...
func (jobMgr *JobMgr) KillJob(name string) (err error) {
	...
	if leaseGrantResp, err = jobMgr.client.Grant(context.TODO(), 1); err != nil {
		return
	}
	...
	// 设置killer标记
	if _, err = jobMgr.client.Put(context.TODO(), killerKey, "", clientv3.WithLease(leaseId)); err != nil {
		return
	}
	return
}
